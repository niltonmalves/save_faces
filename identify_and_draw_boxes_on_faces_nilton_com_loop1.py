...
obama_image = face_recognition.load_image_file(r"C:\Users\Matriz\Documents\rostos_vouga\qq2\know_face\rosto (2).jpg")
...
for npg in range (1 , 432):
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        if matches[best_match_index]:
            ...
            shutil.move(r"C:\Users\Matriz\Documents\rostos_vouga\qq2\rosto (%d).jpg" % npg,r"C:\Users\Matriz\Documents\rostos_vouga\qq2\know_face\rosto (%d).jpg" % npg)
